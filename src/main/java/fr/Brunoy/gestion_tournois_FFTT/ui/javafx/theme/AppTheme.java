...
public final class AppTheme {
    ...
    /**
     * Dégradé diagonal plus premium pour la sidebar.
     */
    ...
    public static final String TOPBAR_STYLE = "-fx-background-color: linear-gradient(to bottom, " + COLOR_SURFACE
            + " 0%, " + COLOR_SURFACE_SOFT + " 100%);" +
    ...
    public static void styleSidebarSecondaryButton(Button btn) {
        ...
        btn.setOnMouseEntered(e -> btn
                .setStyle(SIDEBAR_SECONDARY_BUTTON_STYLE + "-fx-background-color: " + COLOR_SIDEBAR_PANEL_HOVER + ";"));
        btn.setOnMouseExited(e -> btn.setStyle(SIDEBAR_SECONDARY_BUTTON_STYLE));
        btn.setOnMousePressed(e -> btn
                .setStyle(SIDEBAR_SECONDARY_BUTTON_STYLE + "-fx-background-color: " + COLOR_SIDEBAR_PANEL_PRESS + ";"));
    ...
    public static void styleSidebarTournamentItem(Button btn, boolean active) {
        ...
        btn.setOnMouseEntered(e -> btn
                .setStyle(SIDEBAR_TOURNAMENT_ITEM_STYLE + "-fx-background-color: " + COLOR_SIDEBAR_ITEM_HOVER + ";"));
