...
import fr.pingmanager.gestion_tournois_FFTT.domain.competition.model.value.JudgeRefereeAssignment;
import fr.pingmanager.gestion_tournois_FFTT.domain.competition.model.value.RegulationDocumentData;
import fr.pingmanager.gestion_tournois_FFTT.domain.competition.model.value.TournamentRegistrationPolicy;
import fr.pingmanager.gestion_tournois_FFTT.domain.competition.model.value.TournamentRegulationInfo;
import fr.pingmanager.gestion_tournois_FFTT.domain.competition.model.value.RegulationDocumentData.TableauLine;
